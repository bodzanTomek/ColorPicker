...
exports.drawColorSample = drawColorSample;
...
function padLeft(word, expectedChars, fill) {
...
function drawGradient(setGradient, contextColorPalette, size) {
...
function drawColorSample(config) {
...
function colorChanger(colorChangerPosition) {
    var color = _Color2.default.fromHsl({ h: colorChangerPosition, s: 100, l: 50 });
    return {
        red: color.rgb.red,
...
var Color = function () {
    ...
    _createClass(Color, [{
        ...
        value: function toHex() {
            var hex = "#";
            hex += (0, _utils.padLeft)(this.rgb.red.toString(16), 2, "0");
            hex += (0, _utils.padLeft)(this.rgb.green.toString(16), 2, "0");
            hex += (0, _utils.padLeft)(this.rgb.blue.toString(16), 2, "0");
            return hex;
        }
    }, {
        key: "toHsl",
...
var ColorPicker = function () {
    ...
    _createClass(ColorPicker, [{
        key: 'createRoot',
        value: function createRoot(rootId) {
        ...
        value: function setColorPaletteColor(color) {
            this.paletteColor = new _Color2.default(color);
        }
        ...
        value: function setColorSample(x, y) {
            ...
            this.sampleColor = new _Color2.default({ red: this.colorSampleRed, green: this.colorSampleGreen, blue: this.colorSampleBlue });
        }
    }, {
        key: 'drawColorSample',
        value: function drawColorSample() {
            (0, _utils.drawColorSample)({
                color: this.sampleColor.toRgb(),
                context: this.contextColorPalette,
                positionX: this.colorSamplePositionX,
                positionY: this.colorSamplePositionY
        ...
        value: function runColorChanger(colorChangerPosition) {
            var returnedColorChanger = (0, _utils.colorChanger)(colorChangerPosition);
...
var _ColorPickerSmall = __webpack_require__(120);

var _ColorPickerSmall2 = _interopRequireDefault(_ColorPickerSmall);

var _ColorPickerNormal = __webpack_require__(119);

var _ColorPickerNormal2 = _interopRequireDefault(_ColorPickerNormal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.addEventListener('load', function () {
    console.log("main");
    new _ColorPickerSmall2.default({
        id: "colorPicker"
    });
    new _ColorPickerNormal2.default({
        id: "colorPicker2"
    });
});
...
var _ColorPicker2 = __webpack_require__(87);

var _ColorPicker3 = _interopRequireDefault(_ColorPicker2);
...
var ColorPickerNormal = function (_ColorPicker) {
    _inherits(ColorPickerNormal, _ColorPicker);

    function ColorPickerNormal(options) {
        _classCallCheck(this, ColorPickerNormal);

        var _this = _possibleConstructorReturn(this, (ColorPickerNormal.__proto__ || Object.getPrototypeOf(ColorPickerNormal)).call(this, options));

        _this.setColorSample(130, 130);
        _this.drawColorSample();
        _this.setColorAsideElements(_this.sampleColor);
        return _this;
    }

    _createClass(ColorPickerNormal, [{
        key: 'createDOM',
        ...
        key: 'createDOMcolorValuesInput',
        value: function createDOMcolorValuesInput(config) {
        ...
        value: function drawColorPalette(color) {
            ...
            (0, _utils.drawGradient)({ direction: 'horizontal', from: { distance: 0.02, color: "white" }, to: { distance: 0.98, color: color } }, this.contextColorPalette, this.sizeColorPalette);
            (0, _utils.drawGradient)({ direction: 'vertical', from: { distance: 0.02, color: 'rgba(255, 255, 255, 0)' }, to: { distance: 0.98, color: "black" } }, this.contextColorPalette, this.sizeColorPalette);
        }
    }]);

    return ColorPickerNormal;
}(_ColorPicker3.default);

exports.default = ColorPickerNormal;
...
var ColorPickerSmall = function (_ColorPicker) {
    _inherits(ColorPickerSmall, _ColorPicker);

    function ColorPickerSmall(options) {
        _classCallCheck(this, ColorPickerSmall);

        var _this = _possibleConstructorReturn(this, (ColorPickerSmall.__proto__ || Object.getPrototypeOf(ColorPickerSmall)).call(this, options));

        console.log("small");
        _this.setColorSample(80, 80);
        _this.drawColorSample();
        _this.setColorAsideElements(_this.sampleColor);
        return _this;
    }

    _createClass(ColorPickerSmall, [{
        key: 'createDOM',
        value: function createDOM(rootId) {
...
exports.default = ColorPickerSmall;
