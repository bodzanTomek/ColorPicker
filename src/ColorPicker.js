...
export default class ColorPicker {
    ...
    addEventListeners() {
        this.methodRunColorChanger = () => this.runColorChanger(parseInt(this.colorChanger.value));
        ...
        this.methodOnClickedCanvas = (e) => this.onClickedCanvasPixel(e);
    ...
    activateMouseMove() {
        this.colorChanger.addEventListener("mousemove", this.methodRunColorChanger);
        this.colorPalette.addEventListener('mousemove', this.methodOnClickedCanvas);
    }
    deactivateMouseMove() {
        console.log('deakty');
        this.colorChanger.removeEventListener("mousemove", this.methodRunColorChanger);
        this.colorPalette.removeEventListener("mousemove", this.methodOnClickedCanvas);
    }
}